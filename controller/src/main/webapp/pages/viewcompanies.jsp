    ...
    <div class="row">
        ...
        <div class="col-md-10" style="padding-left: 30px">
            <ul class="nav nav-tabs" id="listSelectionTab">
                <li id="allentityTab" class="active"><a data-toggle="tab" href="#allentity"><fmt:message
                        code="view.list.all"/></a></li>
                <li id="contactsTab"><a data-toggle="tab" href="#contacts"><fmt:message
                        code="view.list.contacts"/></a></li>
                <li id="companiesTab"><a data-toggle="tab" href="#companies"><fmt:message
                        code="view.list.companies"/></a></li>
            </ul>
            <div class="tab-content">
                <div id="allentity" class="tab-pane active">
                ...
                <div id="companies" class="tab-pane">
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="col-md-4" align="right">
                                <br>
                                <button type="button" class="btn btn-primary" onclick="location.href='/company'">
                                    <fmt:message code="view.list.company.add"/>
                                </button>
                            </div>
                        </div>
                        <div class="row">
